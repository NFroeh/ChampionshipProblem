namespace ChampionshipProblem.Test.NUnit.ImplementationTests.EA
{
    ...
    public class PortugalTest
    {
        ...
        [TestCase(23, 02, true)]
        [TestCase(23, 03, true)]
        [TestCase(23, 04, false)]
        [TestCase(23, 05, false)]
        [TestCase(23, 06, false)]
        [TestCase(23, 07, false)]
        [TestCase(23, 08, false)]
        [TestCase(23, 09, false)]
        [TestCase(23, 10, false)]
        [TestCase(23, 11, false)]
        ...
        [TestCase(22, 03, true)]
        [TestCase(22, 04, true)]
        [TestCase(22, 05, false)]
        [TestCase(22, 06, false)]
        [TestCase(22, 07, false)]
        [TestCase(22, 08, false)]
        [TestCase(22, 09, false)]
        [TestCase(22, 10, false)]
        [TestCase(22, 11, false)]
        [TestCase(22, 12, false)]
        [TestCase(22, 13, false)]
        ...
        [TestCase(21, 11, false)]
        [TestCase(21, 12, false)]
        [TestCase(21, 13, false)]
        [TestCase(21, 14, false)]
        [TestCase(21, 15, false)]
        ...
        [TestCase(20, 13, false)]
        [TestCase(20, 14, false)]
        ...
        [TestCase(23, 00, true)]
        [TestCase(23, 01, true)]
        [TestCase(23, 02, false)]
        [TestCase(23, 03, false)]
        [TestCase(23, 04, false)]
        [TestCase(23, 05, false)]
        [TestCase(23, 06, false)]
        [TestCase(23, 07, false)]
        ...
        [TestCase(22, 00, true)]
        [TestCase(22, 01, true)]
        [TestCase(22, 02, false)]
        [TestCase(22, 03, false)]
        [TestCase(22, 04, false)]
        [TestCase(22, 05, false)]
        [TestCase(22, 06, false)]
        [TestCase(22, 07, false)]
        [TestCase(22, 08, false)]
        ...
        [TestCase(21, 03, true)]
        [TestCase(21, 04, true)]
        [TestCase(21, 05, false)]
        [TestCase(21, 06, false)]
        [TestCase(21, 07, false)]
        [TestCase(21, 08, false)]
        [TestCase(21, 09, false)]
        [TestCase(21, 10, false)]
        [TestCase(21, 11, false)]
        [TestCase(21, 12, false)]
        [TestCase(21, 13, false)]
        ...
        [TestCase(20, 07, true)]
        [TestCase(20, 08, true)]
        [TestCase(20, 09, false)]
        [TestCase(20, 10, false)]
        [TestCase(20, 11, false)]
        [TestCase(20, 12, false)]
        [TestCase(20, 13, false)]
        [TestCase(20, 14, false)]
        [TestCase(20, 15, false)]
        ...
        [TestCase(19, 09, true)]
        [TestCase(19, 10, true)]
        [TestCase(19, 11, false)]
        [TestCase(19, 12, false)]
        [TestCase(19, 13, false)]
        [TestCase(19, 14, false)]
        [TestCase(19, 15, false)]
        ...
        {
            List<LeagueStandingEntry> standing = LeagueStandingService1617.CalculateStanding(stage);
            Assert.AreEqual(result, new EA1And1Handler().Handle(new ChampionshipProblemInput(LeagueStandingService1617, standing[teamNumber].TeamId, stage)).CanBeChampion);
        }
        #endregion
        ...
        {
            List<LeagueStandingEntry> standing = LeagueStandingService1718.CalculateStanding(stage);
            Assert.AreEqual(result, new EA1And1Handler().Handle(new ChampionshipProblemInput(LeagueStandingService1718, standing[teamNumber].TeamId, stage)).CanBeChampion);
        }
        #endregion
