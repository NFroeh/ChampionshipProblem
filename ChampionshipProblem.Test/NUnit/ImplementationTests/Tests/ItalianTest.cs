namespace ChampionshipProblem.Test.NUnit.ImplementationTests
{
    ...
    public class ItalianTest
    {
        ...
        public void SetUp()
        {
            ...
            LeagueStandingService0809 = new LeagueStandingService(this.ChampionshipViewModel, Classes.Country.Italy, leagueName, "2008/2009");
            LeagueStandingService0910 = new LeagueStandingService(this.ChampionshipViewModel, Classes.Country.Italy, leagueName, "2009/2010");
            LeagueStandingService1011 = new LeagueStandingService(this.ChampionshipViewModel, Classes.Country.Italy, leagueName, "2010/2011");
            LeagueStandingService1213 = new LeagueStandingService(this.ChampionshipViewModel, Classes.Country.Italy, leagueName, "2012/2013");
            LeagueStandingService1314 = new LeagueStandingService(this.ChampionshipViewModel, Classes.Country.Italy, leagueName, "2013/2014");
            LeagueStandingService1415 = new LeagueStandingService(this.ChampionshipViewModel, Classes.Country.Italy, leagueName, "2014/2015");
            LeagueStandingService1516 = new LeagueStandingService(this.ChampionshipViewModel, Classes.Country.Italy, leagueName, "2015/2016");
            LeagueStandingService1617 = new LeagueStandingService(this.ChampionshipViewModel, Classes.Country.Italy, leagueName, "2016/2017");
            LeagueStandingService1718 = new LeagueStandingService(this.ChampionshipViewModel, Classes.Country.Italy, leagueName, "2017/2018");
            LeagueStandingService1819 = new LeagueStandingService(this.ChampionshipViewModel, Classes.Country.Italy, leagueName, "2018/2019");
        }
