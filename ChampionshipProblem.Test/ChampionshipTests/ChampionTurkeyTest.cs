namespace ChampionshipProblem.Test
{
    ...
    /// </summary>
    [TestClass]
    public class ChampionTurkeyTest
    {
        #region consts
        /// <summary>
        /// Der Liganame.
        ...
        public void T0809Test()
        {
            ...
            LeagueStandingService leagueStandingService = new LeagueStandingService(championshipViewModel, Country.Turkey, leagueName, season);
            ...
            stage = 33;
            leagueStandingService = new LeagueStandingService(championshipViewModel, Country.Turkey, leagueName, season);
...
, leagueStandingService.CalculateIfTeamCanWinChampionship(stage, standing[17].TeamId, false).CanWinChampionship);
