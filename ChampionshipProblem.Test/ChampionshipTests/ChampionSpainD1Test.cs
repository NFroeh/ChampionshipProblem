namespace ChampionshipProblem.Test
{
    ...
    /// </summary>
    [TestClass]
    public class ChampionSpainD1Test
    {
        #region consts
        /// <summary>
        /// Der Liganame.
        ...
        public void S0809Test()
        {
            ...
            LeagueStandingService leagueStandingService = new LeagueStandingService(championshipViewModel, Country.Spain, leagueName, season);
            ...
            Assert.AreEqual(false, leagueStandingService.CalculateIfTeamCanWinChampionship(stage, standing[20].TeamId, false).CanWinChampionship);
            Assert.AreEqual(false, leagueStandingService.CalculateIfTeamCanWinChampionship(stage, standing[21].TeamId, false).CanWinChampionship);

            stage = 41;
            leagueStandingService = new LeagueStandingService(championshipViewModel, Country.Spain, leagueName, season);
            ...
            Assert.AreEqual(true, leagueStandingService.CalculateIfTeamCanWinChampionship(stage, standing[20].TeamId, false).CanWinChampionship);
            Assert.AreEqual(false, leagueStandingService.CalculateIfTeamCanWinChampionship(stage, standing[21].TeamId, false).CanWinChampionship);
            ...
            Assert.AreEqual(true, leagueStandingService.CalculateIfTeamCanWinChampionship(stage, standing[19].TeamId, false).CanWinChampionship);
            Assert.AreEqual(true, leagueStandingService.CalculateIfTeamCanWinChampionship(stage, standing[20].TeamId, false).CanWinChampionship);
            Assert.AreEqual(true, leagueStandingService.CalculateIfTeamCanWinChampionship(stage, standing[21].TeamId, false).CanWinChampionship);
